...
const AboutMe = () => {
  ...
  return (
    <div className="relative min-h-screen flex items-center justify-center px-[2rem] py-[1rem]">
      <div className="w-full flex items-center gap-8 justify-center md:flex-row flex-col">
        ...
        <div className="w-full md:w-[50%] flex flex-col gap-8">
          ...
          <button
            onClick={() => router.back()}
            className="
          w-fit bg-[#0A1E46] rounded-md px-3 min-w-[120px] py-2 font-sans font-medium text-white"
          >
            Go Back
          </button>
        </div>
